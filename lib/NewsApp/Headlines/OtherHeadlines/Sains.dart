...
class Sains extends StatefulWidget {
  const Sains({Key? key}) : super(key: key);

  @override
  State<Sains> createState() => _SainsState();
}

class _SainsState extends State<Sains> {
  ...
  Future _getData() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          "https://newsapi.org/v2/top-headlines?country=id&category=science&apiKey=89bdbcf124124d558e1e06af6c91faae"));
