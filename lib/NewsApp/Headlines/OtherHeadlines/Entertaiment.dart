...
class Entertaiment extends StatefulWidget {
  const Entertaiment({Key? key}) : super(key: key);

  @override
  State<Entertaiment> createState() => _EntertaimentState();
}
  ...
  Future _getData() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          "https://newsapi.org/v2/top-headlines?country=id&category=entertainment&apiKey=89bdbcf124124d558e1e06af6c91faae"));
